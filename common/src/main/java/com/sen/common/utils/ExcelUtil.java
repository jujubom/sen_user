...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public ResponseData exportExcel(List<T> list, String sheetName, String title) {
        this.init(list, sheetName, title, Excel.Type.EXPORT);
        return ResponseData.success(exportExcel());
    }
     ...
     * @return 结果
     */
    public ResponseData importTemplateExcel(String sheetName, String title) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SoBuyConfig.getDownloadPath() + filename;
